const SearchBar = ({ setQuery, query }) => {
  ...
  return (
    <div className="relative dark:bg-gray-900 rounded-md">
      <svg
        className="fill-gray-300 dark:fill-white absolute left-4 top-5 w-5 h-5"
        viewBox="0 0 16 16"
      ...
      <input
        ...
        value={query}
        className="w-full rounded-md px-14 py-4 shadow-md placeholder:text-gray-300 dark:text-white dark:placeholder:text-white placeholder:text-sm"
        type="text"
